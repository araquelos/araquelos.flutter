...
class PixCopiaEColaEtapa1 extends StatefulWidget {
  final RecebedorPix recebedorPix;

  const PixCopiaEColaEtapa1({
    super.key,
    required this.recebedorPix,
  });

  @override
  State<PixCopiaEColaEtapa1> createState() => _PixCopiaEColaEtapa1State();
}

class _PixCopiaEColaEtapa1State extends State<PixCopiaEColaEtapa1> {
      ...
      rodape: [
        BotaoPrincipal(
          ...
          onPressed: () {
            ...
            context.pushNamed(InternetBankingRotas.pixCopiaEColaEtapa2, extra: recebedorAtualizado);
          },
        ),
        SizedBox(
          height: MediaQuery.of(context).size.height * 0.01,
