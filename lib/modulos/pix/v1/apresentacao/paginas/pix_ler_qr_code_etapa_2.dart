...
class PixLerQrCodeEtapa2 extends StatefulWidget {
  final RecebedorPix recebedorPix;

  const PixLerQrCodeEtapa2({super.key, required this.recebedorPix});

  @override
  State<PixLerQrCodeEtapa2> createState() => _PixLerQrCodeEtapa2State();
}

class _PixLerQrCodeEtapa2State extends State<PixLerQrCodeEtapa2> {
  ...
  Widget build(BuildContext context) {
    return LayoutPadrao(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Visibility(
                      visible: widget.recebedorPix.dataVencimento != '' ? true : false,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          AutoSizeText(
                          ...
                          AutoSizeText(
                            widget.recebedorPix.dataVencimento != ''
                                ? UtilData.obterDataDDMMAAAA(DateTime.parse(widget.recebedorPix.dataVencimento))
                                : '',
                            style: GoogleFonts.barlow(
                                color: InternetBankingCores.azul_500, fontWeight: FontWeight.w600, fontSize: 14),
                            maxLines: 1,
                    ...
                    Visibility(
                      visible: widget.recebedorPix.dataExpiracao != '' ? true : false,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          AutoSizeText(
                          ...
                          AutoSizeText(
                            widget.recebedorPix.dataExpiracao != ''
                                ? UtilData.obterDataDDMMAAAA(
                                    DateTime.parse(widget.recebedorPix.dataExpiracao),
                                  )
                                : '',
                            style: GoogleFonts.barlow(
                                color: InternetBankingCores.azul_500, fontWeight: FontWeight.w600, fontSize: 14),
        ...
        acaoVoltar: () {
          ...
          recebedorAtualizado.valor = ctlValor.text == ""
              ? widget.recebedorPix.valor
              : UtilBrasilFields.converterMoedaParaDouble(ctlValor.text);
          context.go(InternetBankingRotas.pixLerQrCodeEtapa1, extra: recebedorAtualizado);*/
          context.pop();
        });
  }
}
