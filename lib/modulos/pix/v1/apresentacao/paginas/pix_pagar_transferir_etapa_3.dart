...
import 'package:mobile_pj/modulos/pix/v1/apresentacao/componentes/actionsheet_pagamento_sucesso.dart';
...
class PixPagarTransferirEtapa3 extends StatefulWidget {
  final RecebedorPix recebedorPix;

  const PixPagarTransferirEtapa3({super.key, required this.recebedorPix});

  @override
  State<PixPagarTransferirEtapa3> createState() =>
      _PixPagarTransferirEtapa3State();
}

class _PixPagarTransferirEtapa3State extends State<PixPagarTransferirEtapa3> {
  final PixPagarTransferirForm pixPagarTransferirForm =
      PixPagarTransferirForm();
  ...
  Widget build(BuildContext context) {
    return LayoutPadrao(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CampoValorPix(
                    controller: ctlValor,
                    label: 'Valor do Pix',
                    hintText: UtilBrasilFields.obterReal(
                        widget.recebedorPix.valor,
                        moeda: true,
                        decimal: 2),
                    valorPadrao: UtilBrasilFields.obterReal(
                        widget.recebedorPix.valor,
                        moeda: true,
                        decimal: 2),
                    ...
                    children: [
                      AutoSizeText(
                        ...
                        style: GoogleFonts.barlow(
                            color: InternetBankingCores.cinza_700,
                            fontSize: 14,
                  ...
                  const InfoAlerta(
                    ...
                    info:
                        'Para agendar o pagamento, selecione uma data futura.',
                  ),
                  SizedBox(
                    height: MediaQuery.of(context).size.height * 0.01,
                  ),
                  CampoDataIcone(
                    ...
                    onSaved: (valor) =>
                        pixPagarTransferirForm.dataPagamento = valor,
                  ),
                  SizedBox(
                    height: MediaQuery.of(context).size.height * 0.01,
                  ),
                  CampoTextoFormulario(
                    ...
                    label: 'Descrição',
                    onSaved: (valor) =>
                        pixPagarTransferirForm.descricao = valor,
                  ),
                  SwitchSalvarContato(
                    value: pixPagarTransferirForm.salvarContato,
                    onChanged: () {
                      setState(() {
                        pixPagarTransferirForm.salvarContato =
                            !pixPagarTransferirForm.salvarContato;
                      });
                    },
                  ),
      ...
      rodape: [
        BotaoPrincipal(
          texto:
              "Pagar R\$ ${UtilBrasilFields.obterReal(widget.recebedorPix.valor, moeda: false, decimal: 2)}",
          onPressed: () =>
              ActionSheetPagamentoSucesso.exibirModalDetalhar(context),
        ),
        SizedBox(
          height: MediaQuery.of(context).size.height * 0.01,
        ),
      ...
      acaoVoltar: () {
        ...
        context.go(InternetBankingRotas.pixPagarTransferirEtapa2, extra: recebedorAtualizado);*/
        context.pop();
      },
    );
  }
