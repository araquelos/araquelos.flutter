...
class PixLerQrCodeEtapa1 extends StatefulWidget {
  final RecebedorPix recebedorPix;

  const PixLerQrCodeEtapa1({super.key, required this.recebedorPix});

  @override
  State<PixLerQrCodeEtapa1> createState() => _PixLerQrCodeEtapa1State();
}

class _PixLerQrCodeEtapa1State extends State<PixLerQrCodeEtapa1> {
      ...
      rodape: [
        BotaoPrincipal(
          ...
          onPressed: () {
            ...
            context.pushNamed(InternetBankingRotas.pixLerQrCodeEtapa2, extra: recebedorAtualizado);
          },
        ),
        SizedBox(
          height: MediaQuery.of(context).size.height * 0.01,
